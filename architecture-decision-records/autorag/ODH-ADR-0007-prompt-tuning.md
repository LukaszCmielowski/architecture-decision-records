...
Full-benchmark metrics for Stage 2 are the catalog in [RAG pattern evaluation](./ODH-ADR-0005-rag-pattern-evaluation.md) (Unitxt, Ragas, and `overall_score`). GAM ranks by `optimization_metric` and optional `optimization_evaluator`.
